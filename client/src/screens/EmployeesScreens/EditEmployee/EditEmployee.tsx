...
const EditEmployeeScreen = ({ navigation, props }: any) => {
  ...
  const handleDonePress = async () => {
    try {
      await OrderService.patchOrders(
        data.orderID,
        data.IDclient,
        data.IDproduct,
        quantity,
      ...
      <View style={style.providers as any}>
        <RNPickerSelect
          ...
          items={valuesForProduct.map((el: any, index: number) => {
            return {
              label: labelsForProduct[index],
              value: valuesForProduct[index],
            };
          })}
        ></RNPickerSelect>
      </View>
      ...
      <View style={style.providers as any}>
        <RNPickerSelect
          ...
          items={valuesForEmployee.map((el: any, index: number) => {
            return {
              label: labelsForEmployee[index],
              value: valuesForEmployee[index],
            };
          })}
        ></RNPickerSelect>
      </View>
